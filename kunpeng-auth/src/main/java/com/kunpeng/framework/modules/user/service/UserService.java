...
import com.kunpeng.framework.modules.dept.mapper.customer.DeptCustomerMapper;
...
import com.kunpeng.framework.modules.user.enums.UserStatusEnum;
...
//                )
    ...
    public void saveUser(UserEditParamPO userEditParamPO) {
        ...
        userPO.setPassword(new BCryptPasswordEncoder().encode(kunPengUserProperties.getDefaultPassword()));
