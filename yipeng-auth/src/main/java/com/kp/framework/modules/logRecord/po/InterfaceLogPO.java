...
/**
 * @Author lipeng
 * @Description 系统内部接口调用记录
 * @Date 2025-05-28
**/
@Data
@Accessors(chain = true)
@TableName("auth_interface_log")
@ApiModel(value = "InterfaceLogPO对象", description = "系统内部接口调用记录")
public class InterfaceLogPO extends ParentBO {
