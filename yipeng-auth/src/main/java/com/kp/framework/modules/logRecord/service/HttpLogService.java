...
public class HttpLogService extends ServiceImpl<HttpLogMapper, HttpLogPO> {
     ...
     * @author lipeng
     * 2025-05-21
     * @param httpLogListParamPO 查询参数
     * @return com.kp.framework.entity.bo.KPResult<?>
     */
    public KPResult<?> queryPageList(HttpLogListParamPO httpLogListParamPO) {
        ...
        return KPResult.list(
                httpLogHistoryMapper.selectList(new LambdaQueryWrapper<>(HttpLogHistoryPO.class)
     ...
     * @return com.kp.framework.modules.logRecord.po.HttpLogPO
     */
