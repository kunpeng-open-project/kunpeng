...
//    }
    ...
    private static void record(String url, String method, String parameters, String result, long disposeDate) {
        try {
            KunPengLogRecordProperties kunPengLogRecordProperties = KPServiceUtil.getBean(KunPengLogRecordProperties.class);
            if (!kunPengLogRecordProperties.getHttpLog()) return;
