...
public class ApiJsonlParamModeUtil {
    ...
    //动态生成的Class的包路径 自由定义
    private final static String BASE_PACKAGE = "com.kunpeng.framework.swagger.json.parameter.entity.";
    //包含默认类名
    private final static String INCLUDE_CLASS_NAME = "KunPengJsonParamIncludeBO";
    //包含序号防止重名
    private static Integer INCLUDE_SORT = 1;
    //包含默认类名
    private final static String IGNORES_CLASS_NAME = "KunPengJsonParamIgnoresBO";
    //包含序号防止重名
