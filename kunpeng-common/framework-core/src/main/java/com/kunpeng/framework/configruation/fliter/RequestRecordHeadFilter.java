...
import com.kunpeng.framework.configruation.config.MyResponseWrapper;
import com.kunpeng.framework.configruation.mq.InterfaceRabbitMqConfig;
import com.kunpeng.framework.configruation.properties.KunPengLogRecordProperties;
import com.kunpeng.framework.utils.LogUtil;
import com.kunpeng.framework.utils.kptool.KPJsonUtil;
import com.kunpeng.framework.utils.kptool.KPRabbitMqUtil;
...
public class RequestRecordHeadFilter implements Filter {
	...
	@Autowired
	private KunPengLogRecordProperties kunPengLogRecordProperties;
		...
		try {
			...
			if (handlerMethod != null) {
				...
				if (kpExcludeInterfaceJournal == null) {
					if (kunPengLogRecordProperties.getInterfaceLog())
